...
public class OutputMsg {
    ...
    public static String MenuMessage =
            ...
            ConsoleColors.PURPLE_BOLD_BRIGHT + " \uD83D\uDFE0 Show SalesRep ➡️ " + ConsoleColors.RESET + "Display a " +
            "list of " +
            "available SalesRep" + "\n" +
            ...
            ConsoleColors.PURPLE_BOLD_BRIGHT + " \uD83D\uDFE2 Show Leads ➡️ " + ConsoleColors.RESET + "Display a list" +
            " " +
            "of available " +
            "Leads" + "\n" +
